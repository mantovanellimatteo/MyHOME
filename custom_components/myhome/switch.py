...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    for _switch in _configured_switches.keys():
        _switch = MyHOMESwitch(
            ...
            interface=_configured_switches[_switch].get(CONF_BUS_INTERFACE),
            name=_configured_switches[_switch].get(CONF_NAME),
            entity_name=_configured_switches[_switch].get(CONF_ENTITY_NAME),
            device_class=_configured_switches[_switch].get(CONF_DEVICE_CLASS, SwitchDeviceClass.SWITCH),
            manufacturer=_configured_switches[_switch].get(CONF_MANUFACTURER, "BTicino S.p.A."),
            model=_configured_switches[_switch].get(CONF_DEVICE_MODEL, None),
